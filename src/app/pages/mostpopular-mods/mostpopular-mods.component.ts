...
@Component({
  selector: "app-mostpopular-mods",
  templateUrl: "./mostpopular-mods.component.html",
  styleUrls: ["./mostpopular-mods.component.css"],
})
export class MostpopularModsComponent implements OnInit {
  modDetail: any;
  selectedDate: any;
  userId: any;
  timeRanges: any = [];
