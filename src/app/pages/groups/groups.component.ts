            ...
            this.pageService.getMyMods(filters).subscribe(
              (res: any) => {
                ...
                if (res.success) {
                  ...
                  console.log(this.allMods.length, "this.allMods.length");
...
let data =  {shareType: shareType, postType: "modPost", postID: modData.id}
this.sharedService.Onshare(data).subscribe(
  (res: any) => {
    if (res.success) {
