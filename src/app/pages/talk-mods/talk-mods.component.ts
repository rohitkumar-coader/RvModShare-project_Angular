...
@Component({
  selector: "app-talk-mods",
  templateUrl: "./talk-mods.component.html",
  styleUrls: ["./talk-mods.component.scss"],
})
export class TalkModsComponent implements OnInit {
  allMods = [];
  ...
  ngOnInit() {
    ...
    //   let tab3 = document.getElementById("pills-Talk-tab").click();
  ...
  getMyMods() {
    ...
    if (this.credentials)
      this.pageService.getCommentedModPosts(filters).subscribe(
        (res: any) => {
          this.allMods = [];
          if (res.success) {
            ...
            console.log(this.allMods.length, "this.allMods.length before");
            for (let index = 0; index < res.data.length; index++) {
              let new_element = {
                typeOfPost: "google-ad",
              };
              // if (res.data.length<4 && index!=0) {
            ...
            console.log(this.allMods.length, "this.allMods.length after");
            this.updatedata();
          } else {
